...
calcDrug<-function(allTog,nameDrug,x1,value,score){ 
  ...
  modality<-data.frame(unique(allTog[which(allTog$drug.name==nameDrug),c(x1,value,score)])) 
...
# generation of composite scores
